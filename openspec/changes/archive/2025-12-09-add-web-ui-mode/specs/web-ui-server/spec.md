---
capability: web-ui-server
type: spec-delta
change: add-web-ui-mode
---

# Spec Delta: Web UI Server

This spec delta defines a new capability for running a web server that exposes REST APIs for managing SpecDeck entities.
