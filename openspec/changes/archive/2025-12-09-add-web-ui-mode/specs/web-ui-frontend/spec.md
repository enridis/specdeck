---
capability: web-ui-frontend
type: spec-delta
change: add-web-ui-mode
---

# Spec Delta: Web UI Frontend

This spec delta defines a new capability for a React-based web interface for managing SpecDeck entities.
