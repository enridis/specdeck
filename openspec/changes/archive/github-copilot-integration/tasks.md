...
✅ **Change Complete**: 2025-12-07

All tasks completed successfully:
- ✅ 4 prompt template files created with comprehensive guidance
- ✅ AGENTS.md.template for managed block pattern
- ✅ `specdeck init copilot` command implemented and tested
- ✅ `specdeck upgrade copilot` command with backup/versioning
- ✅ Template bundling via build script
- ✅ Idempotency verified
- ✅ Dogfooded in SpecDeck project itself
